...
function Net() {
  return (
    <>
      <div style={{textAlign: 'center', marginTop: '100px', marginBottom: '10px', background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", padding: '50px', borderRadius: '10px', width: '100vw'}}>
